...
type pageCUsersalexaDocumentsGitHubbodilEnergyOpgavesrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type pageCUsersalexaDocumentsGitHubbodilEnergyOpgavesrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
...
type staticCUsersalexaDocumentsGitHubbodilEnergyOpgavesrccomponentsseoJs63159454QueryVariables = Exact<{ [key: string]: never; }>;


type staticCUsersalexaDocumentsGitHubbodilEnergyOpgavesrccomponentsseoJs63159454Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };
